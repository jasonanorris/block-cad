...
A simple browser-based 3D modeling project. The current milestone supports adding, selecting, moving, rotating, sizing, duplicating, deleting, undoing, and redoing changes to boxes, cylinders, and spheres on a gridded 3D workplane.
